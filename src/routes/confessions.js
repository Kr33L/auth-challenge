...
function get(req, res) {
	const cookie_session_id = req.signedCookies.sid;
	const db_session_id = getSession(cookie_session_id);
	const user_id = db_session_id && db_session_id.user_id;
...
function post(req, res) {
	...
	const cookie_session_id = req.signedCookies.sid;
	const db_session_id = getSession(cookie_session_id);
	const current_user = db_session_id && db_session_id.user_id;
